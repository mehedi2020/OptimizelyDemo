using OptimizelyDemo.Controllers;
...
namespace OptimizelyDemo.Business.Rendering;
...
public class TemplateCoordinator : IViewTemplateModelRegistrator
{
    ...
    public void Register(TemplateModelCollection viewTemplateModelRegistrator)
    {
        ...
        viewTemplateModelRegistrator.Add(typeof(GetInTouchBlock), new TemplateModel
        {
            Name = "GetInTouchBlockWide",
            Tags = [Globals.ContentAreaTags.WideWidth, Globals.ContentAreaTags.FullWidth],
            AvailableWithoutTag = false,
